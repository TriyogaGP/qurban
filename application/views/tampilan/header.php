                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-shopping-cart"></i> Purchase Order <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=base_url('keranjang')?>"><i class="fa fa-shopping-cart"></i> Keranjang<?php if($this->session->userdata('ses_level') == 3){ ?> <span class="label label-success pull-right" data-toggle="tooltip" data-placement="right" title="Total keranjang anda"><div class="totalKeranjang"><?=$jml_keranjang?></div></span><?php } ?></a></li>
                  ...
                  <li><a><i class="fa fa-users"></i> Customers <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=base_url('customer/0')?>"><i class="fa fa-user"></i> Customer<?php if($this->session->userdata('ses_level') == 3){ ?> <span class="label label-success pull-right" data-toggle="tooltip" data-placement="right" title="Total customer anda"><div class="totalCustomer"><?=$jml_customer?></div></span><?php } ?></a></li>
